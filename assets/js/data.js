...
const SKILLS = [
  ...
  },
  {
    ...
    blurb: "Landmark detection and precise facial-geometry measurement.",
    children: [
      { label: "Landmark Detection (MediaPipe)", short: "Landmarks", value: 5 },
      { label: "Facial-Geometry Measurement", short: "Face Geometry", value: 4 },
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Rate-Limit Handling", short: "Rate Limits", value: 4 },
...
const PROJECTS = [
  {
    ...
    detail: [
      ...
      "Implemented export pipelines producing Parquet, JSONL, and WebDataset-ready releases with deterministic train/validation/test splits.",
  ...
  },
  {
    ...
    viz: "face",
    summary: "A computer-vision microservice combining facial-geometry measurement with a RAG-powered analysis layer: landmark detection, symmetry and proportion scoring, and structured assessment-style output.",
    ...
    detail: [
      ...
      "Implemented quantitative facial-geometry assessments including symmetry, proportion, and landmark-normalized comparisons using Procrustes analysis.",
  ...
  },
  {
    ...
    scale: "800K+ images",
    viz: "crawler",
    summary: "Seven site-specific scraping pipelines collecting public-domain and openly licensed artwork images and metadata from national libraries and museums across six countries.",
    ...
    detail: [
      ...
      "Rebuilt the highest-volume scraper as a pure-HTTP client where direct requests were appropriate, improving throughput by roughly 50x while preserving retry, logging, and controlled batch execution.",
  ...
  {
    index: "04",
    name: "Large-Scale Literature Publishing Platform",
    scale: "74M records",
    viz: "library",
  ...
  },
  {
    ...
    detail: [
      "TextOllama & Textgen: local Ollama and cloud OpenAI Batch API pipelines for schema-validated text processing with checkpoint/resume support.",
      "ImagesGPT: large-scale image captioning over the OpenAI Batch API, including a constant-memory streaming mode that keeps usage around ~100MB regardless of collection size.",
      "Moondream pipeline: local/cloud VLM processing supporting captioning, visual QA, object detection, and point localization.",
      "Caption Fusion: CSV-merge and ExifTool-based metadata-writing utility for operationalizing caption datasets into image files.",
  ...
  },
  {
    ...
    detail: [
      ...
      "Designed a thumbnail-first web service: fast 400px previews with on-demand full-resolution generation through a Celery/Redis queue.",
    ],
  },
  {
    index: "07",
    ...
    detail: [
      ...
      "Documented recurring failure modes (over-disclosure, missing elicitation, jailbreak-susceptibility patterns) that fed preference-pair construction.",
  ...
  },
  {
    ...
    viz: "homelab",
    summary: "A self-managed KVM virtualization cluster across three physical machines: the distributed compute, shared storage, and network isolation behind large-scale batch and AI workloads.",
    tags: ["KVM", "libvirt", "NFS", "systemd", "OpenVPN", "Ubuntu Server"],
    detail: [
      "Provisioned 30+ Ubuntu 22.04 VMs across three physical hosts with mixed CPU/GPU capacity, each deliberately thin (3GB RAM, one vCPU, minimal install) to pack 10+ parallel workers per machine.",
      ...
      "Configured systemd-managed VPN egress and network isolation for long-running batch jobs, keeping workloads separated across VMs and hosts.",
      ...
      "Supported high-volume batch-generation workloads producing 50M+ structured text artifacts and metadata records through Groq and Vertex AI.",
    ],
  },
];

// Grouped for readability; each group renders with its own heading.
const MORE_BUILDS = [
  {
    group: "AI-Powered Products",
    items: [
      { name: "PrintAI", desc: "A full-stack AI image-generation storefront: Stability API for images, Printful for print-on-demand fulfillment, Stripe for payments, Google/Facebook OAuth." },
...
const TIMELINE = [
  { role: "AI Dataset Infrastructure Engineer", org: "Penta Springs · AI Dataset Project", type: "Contract", period: "Jan 2026 – May 2026", note: "3M-image dataset factory for VLM pretraining and RAG workflows." },
  { role: "OpenClaw CUA Trajectory Specialist", org: "Turing", type: "Contract", period: "Apr 2026 – Jun 2026", note: "SFT/RLHF trajectories across 150+ agent tools." },
  { role: "LLM Trainer / Benchmark Developer", org: "Turing", type: "Contract", period: "Aug 2025 – Oct 2025", note: "Multimodal evaluation and containerized benchmark design." },
  { role: "Python Developer", org: "QOVES", type: "Contract", period: "Feb 2024 – Jun 2025", note: "FastAPI computer-vision microservice; cut inference from 8s to 2s per face." },
  { role: "Software Engineer", org: "Penta Springs · Publishing Platform", type: "Part-time", period: "Jun 2023 – Aug 2025", note: "Flask/MySQL platform, 74M-record library, server ops." },
  { role: "LLM Trainer · Instruction Following", org: "Turing", type: "Contract", period: "Oct 2024 – Dec 2024", note: "Multi-turn benchmark tasks and rubric-based evaluation materials." },
  { role: "Freelance Software Engineer", org: "Independent", type: "Freelance", period: "Oct 2022 – May 2023", note: "RAG chatbot, third-party API integrations, cultural-heritage scraping toolkit." },
  { role: "Technical Intern", org: "Ministry of Interior, Kenya", type: "Internship", period: "Jul 2022 – Sep 2022", note: "Hardware/software support for 50+ staff." },
];
